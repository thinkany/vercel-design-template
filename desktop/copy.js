  ...
  site: {
    ...
    settings: {
      ...
      wp: {
        ...
        pluginHint: "Save the plugin, upload it on the WordPress site (Plugins → Add New → Upload), activate it, then open Settings → thinkany design Export for the token. It only reads, so it's safe on a live site; deactivate it once you're done.",
