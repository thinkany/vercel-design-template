  ...
  site: {
    ...
    help: {
      pages: {
        ...
        sections: [
          { h: "Edit a page", items: ["<b>Page settings</b>: title, address, parent page.", "<b>SEO</b> (the last section): SEO title, meta description, share image, keyphrase, and whether search engines may list the page. These go into the page's head on every version of the site: published, gated preview and local.", "<b>Save page</b> writes the changes; the Site tab updates right away."] },
