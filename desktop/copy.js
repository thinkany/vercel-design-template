...
window.COPY = {
  ...
  site: {
    ...
    postTagsHintFirst: "Pick a tag other posts use, or type a new one and press Enter. The FIRST tag is part of the post's address (Settings → Blog), so changing it moves the post; menu links follow.",
