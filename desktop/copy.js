...
window.COPY = {
  ...
  site: {
    ...
    help: {
      ...
      nav: {
        ...
        sections: [
          ...
          { h: "Mega menu", items: ["When the site’s header was designed with a mega menu, each link also offers <b>+ Add column</b>: a heading, its links and an optional feature panel (image, title, text, link). Headers designed with a plain dropdown don’t show columns.", "Drag to rearrange: a link moves with its group, sub-links and column links can be dropped into any group or column, or between top-level links to become one."] },
    ...
    settings: {
      ...
      faviconHint: "Shown in the tab, bookmarks and search results. An SVG is best (sharp at every size). Otherwise a square PNG, 512 × 512 or larger. Kept as uploaded, not converted.",
