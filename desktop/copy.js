...
window.COPY = {
  ...
  site: {
    ...
    help: {
      ...
      nav: {
        ...
        sections: [
          ...
          { h: "Footer links", items: ["The footer's own list, independent of the header menu. It starts as a copy of the design's footer links; from then on the two are managed separately."] },
    ...
    footerDesc: "The footer's own links. Independent of the header menu: change one without touching the other.",
    legalHeading: "Legal",
