    ...
    help: {
      ...
      settings: {
        ...
        sections: [
          ...
          { h: "Blog", items: ["<b>Create with AI</b>, above the Filter section: give a title and a brief, and Claude writes the post in the site's copy voice (the Copy Voice drawer in the rail), with its summary, tags and search fields. It lands as a draft, open for your review; nothing publishes until you do.", "<b>Posts Directory</b> is the address posts are listed under and served from (<i>/blog</i>, <i>/blog/my-post</i>). Change it to <i>news</i>, <i>journal</i>, whatever fits. Menu links to posts follow the change, and no page may take that address."] },
