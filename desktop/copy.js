    ...
    help: {
      ...
      nav: {
        ...
        sections: [
          ...
          { h: "Footer links", items: ["The footer's own list, independent of the header menu. It starts as a copy of the design's footer links; from then on the two are managed separately.", "<b>Columns</b>: add sub-links to a footer link (or drop links into it) and it becomes a column headed by its text; leave its address empty when the heading shouldn't be a link."] },
