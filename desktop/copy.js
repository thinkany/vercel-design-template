...
window.COPY = {
  ...
  site: {
    ...
    help: {
      ...
      nav: {
        ...
        sections: [
          ...
          { h: "Footer", items: ["<b>Footer copy</b>: a design that wrote a line into its footer (a tagline, a short note) shows it here as a field, prefilled with the design's words. Not every footer has one.", "The footer's own list, independent of the header menu. It starts as a copy of the design's footer links; from then on the two are managed separately.", "<b>Columns</b>: add sub-links to a footer link (or drop links into it) and it becomes a column headed by its text; leave its address empty when the heading shouldn't be a link."] },
    ...
    footerCopyDesc: "The lines the design wrote into the footer, a tagline or a short note. They start as the design's words; change them here.",
    footerLinksHeading: "Footer links",
