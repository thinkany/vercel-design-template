...
contextBridge.exposeInMainWorld("desktop", {
  ...
  getMediaTags: () => ipcRenderer.invoke("media:tags"),
  addMediaTag: (name) => ipcRenderer.invoke("media:addTag", { name }),
  renameMediaTag: (from, to) => ipcRenderer.invoke("media:renameTag", { from, to }),
  deleteMediaTag: (name) => ipcRenderer.invoke("media:deleteTag", { name }),
