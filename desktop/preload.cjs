...
contextBridge.exposeInMainWorld("desktop", {
  ...
  saveIntakeProgress: (progress) => ipcRenderer.invoke("intake:saveProgress", { progress }),
  getIntakeProgress: () => ipcRenderer.invoke("intake:getProgress"),
  clearIntakeProgress: () => ipcRenderer.invoke("intake:clearProgress"),
  restoreIntake: (brief, deliverableType, projectType) => ipcRenderer.invoke("intake:restore", { brief, deliverableType, projectType }),
  ...
  checkMenu: (variationId, site) => ipcRenderer.invoke("menu:check", { variationId, site: !!site }),
  loadMenuFindings: (id) => ipcRenderer.invoke("menu:load", { id }),
  saveMenuFindings: (id, dismissed) => ipcRenderer.invoke("menu:save", { id, dismissed }),
  reseedHeader: (variationId) => ipcRenderer.invoke("menu:reseed", { variationId }),
  ...
  setUsage: (usage) => ipcRenderer.invoke("usage:set", { usage }),
  ...
  saveSiteSettings: (nav, footerLinks, legal, footer, contact) => ipcRenderer.invoke("site:saveSite", { nav, footerLinks, legal, footer, contact }),
  ...
  richAssist: (markdown, instruction, kind) => ipcRenderer.invoke("rich:assist", { markdown, instruction, kind }),
  ...
  phoneStart: (target) => ipcRenderer.invoke("phone:start", { target }),
  ...
  deleteMediaTag: (name, kind) => ipcRenderer.invoke("media:deleteTag", { name, kind }),
  ...
  // WordPress migration (Site → Settings → Import from WordPress; docs/wordpress-migration-spec.md).
  wpStatus: () => ipcRenderer.invoke("wp:status"),
  wpSavePlugin: () => ipcRenderer.invoke("wp:savePlugin"),
