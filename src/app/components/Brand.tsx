...
export function Brand({ onNavigate }: Props) {
  return (
    <div className="min-h-screen w-full bg-ta-surface flex flex-col items-center justify-center px-8 py-20 text-center">
      ...
      <p className="font-ta-serif text-[17px] text-ta-body leading-[1.6] max-w-[460px] mb-9">
