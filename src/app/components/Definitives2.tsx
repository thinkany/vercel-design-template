...
export function Definitives2({ onNavigate }: Props) {
  ...
  return (
    <div style={{ fontFamily: "'Crimson Pro', Georgia, serif", background: "#faf8f3", minHeight: "100vh", color: "#1a1612" }}>
      ...
      <header style={{ maxWidth: 900, margin: "0 auto", padding: "48px 32px 0", position: "relative" }}>
        <div style={{ position: "absolute", left: -20, top: 56, fontFamily: "'Caveat', cursive", fontSize: 14, color: "#a0856a", transform: "rotate(-2deg)", whiteSpace: "nowrap" }}>since 2004 ↓</div>
      ...
      {/* Page title — like a chapter opening */}
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "52px 32px 0" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 220px", gap: 48, alignItems: "start" }}>
          <div>
            {/* Handwritten label */}
            <div style={{ fontFamily: "'Caveat', cursive", fontSize: 16, color: "#a0856a", marginBottom: 8, display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div style={{ paddingTop: 60 }}>
            <div style={{ fontFamily: "'Caveat', cursive", fontSize: 18, color: "#a0856a", marginBottom: 16, borderBottom: "1px dashed #c9b99a", paddingBottom: 10 }}>Archive</div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 220px", gap: 48, marginTop: 48 }}>
          <div>
            ...
            {visible.map((film) => (
              <article key={film.id} style={{ display: "grid", gridTemplateColumns: "160px 1fr", gap: 20, marginBottom: 36, paddingBottom: 36, borderBottom: "1px solid #ddd2c0" }}>
                ...
                <div>
                  <div style={{ fontFamily: "'Caveat', cursive", fontSize: 12, color: "#b89a7e", marginBottom: 6 }}>{film.date} · {film.decade}</div>
                  ...
                  <a href="#" onClick={(e) => e.preventDefault()} style={{ display: "inline-block", marginTop: 10, fontFamily: "'Lora', Georgia, serif", fontSize: 13, fontStyle: "italic", color: "#7a6655", textDecoration: "underline", textDecorationColor: "#c9b99a", textUnderlineOffset: 3 }}>
                    Read the essay →
                  </a>
                </div>
              </article>
            ...
            <div style={{ display: "flex", gap: 8, alignItems: "center", paddingTop: 8 }}>
              ...
              <span style={{ fontFamily: "'Caveat', cursive", fontSize: 14, color: "#b89a7e" }}>… 31</span>
          ...
          {/* Sidebar */}
          <aside>
            <div style={{ fontFamily: "'Caveat', cursive", fontSize: 18, color: "#a0856a", marginBottom: 16, borderBottom: "1px dashed #c9b99a", paddingBottom: 10 }}>Latest reviews</div>
            ...
            <div style={{ marginTop: 24, fontFamily: "'Caveat', cursive", fontSize: 18, color: "#a0856a", marginBottom: 16, borderBottom: "1px dashed #c9b99a", paddingBottom: 10 }}>Browse by decade</div>
